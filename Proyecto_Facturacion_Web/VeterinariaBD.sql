...
CREATE TABLE CLIENTE(
	...
	CEDULA VARCHAR(20) UNIQUE NOT NULL,  -- 20 PUEDE SER PERSONA CON CEDULA EXTRANJERA 
...
CREATE TABLE TRABAJADOR(
	...
	TELEFONO VARCHAR(11) NULL,
	EMAIL  VARCHAR(45) NOT NULL,
	PUESTO_TRABAJO VARCHAR(35) NOT NULL
)
GO
...
INSERT INTO CLIENTE(CEDULA,NOMBRE,APELLIDO,TELEFONO,EMAIL) 
			VALUES('208030487','Mariel','Rojas','83912061','marielrojas50@gmail.com'),
				  ('208000304','Veronica','Blanco','60227090','vero.bro14@gmail.com'),
				  ('203890954','Mauren','Sánchez','688360383','sanc64@gmail.com'),
				  ('207270446','Estefany','Rojas','85684516','tefyro@gmail.com');
								

INSERT INTO TRABAJADOR(CEDULA,NOMBRE,APELLIDO,TELEFONO,EMAIL,PUESTO_TRABAJO) 
			VALUES('204550899','Juan','Pacheco','83915648','juan50@gmail.com','Vendedor'),
				  ('208050961','Andres','Lopez','60228040','andre@gmail.com','Veterinaria');
	
	
INSERT INTO PRODUCTO(NOMBRE,PRECIO,CANTIDAD_DISPONIBLE,FECHA_VENCIMIENTO,LOTE,CATEGORIA)
			VALUES('Purina Cat Show',1300,94,'25/06/2024','A1','Alimento'),
				 ('Súper Perro',1400,58,'28/04/2024','A1','Alimento'),
				 ('Bola goma',1700,8,NULL,NULL,'Juguetes'),
				 ('Purina Pro Plan',2000,26,'28/08/2024','A1','Alimento'),
				 ('Peluche dinosaurio',1400,11,	NULL,NULL,'Juguetes'),
				 ('NexGard',5400,30,'12/12/2023','A4','Medicamentos');
...
BEGIN
    ...
    BEGIN
        UPDATE CLIENTE
        SET CEDULA = @CEDULA, NOMBRE = @NOMBRE, APELLIDO=@APELLIDO,TELEFONO = @TELEFONO, EMAIL=@EMAIL
...
AS
BEGIN
    IF (EXISTS (SELECT * FROM TRABAJADOR WHERE CEDULA = @CEDULA))
    BEGIN
    ...
    BEGIN
        INSERT INTO TRABAJADOR(CEDULA,NOMBRE,APELLIDO,TELEFONO,EMAIL,PUESTO_TRABAJO)
        VALUES (@CEDULA,@NOMBRE,@APELLIDO,@TELEFONO,@EMAIL,@PUESTO_TRABAJO);
...
BEGIN
    ...
    BEGIN
        UPDATE TRABAJADOR 
        SET CEDULA = @CEDULA, NOMBRE = @NOMBRE, APELLIDO=@APELLIDO,TELEFONO = @TELEFONO, EMAIL=@EMAIL,PUESTO_TRABAJO =@PUESTO_TRABAJO
...
BEGIN
    ...
    BEGIN
        INSERT INTO PRODUCTO(NOMBRE,PRECIO,CANTIDAD_DISPONIBLE,FECHA_VENCIMIENTO,LOTE,CATEGORIA)
        VALUES (@NOMBRE,@PRECIO,@CANTIDAD_DISPONIBLE,@FECHA_VENCIMIENTO,@LOTE,@CATEGORIA);
...
BEGIN
    ...
    BEGIN
        UPDATE PRODUCTO
        SET NOMBRE = @NOMBRE,PRECIO=@PRECIO,CANTIDAD_DISPONIBLE =@CANTIDAD_DISPONIBLE,FECHA_VENCIMIENTO =@FECHA_VENCIMIENTO,LOTE=@LOTE,CATEGORIA=@CATEGORIA
